...
class Locker extends LockerBase {
	 ...
	 *   @param {Number} [options.downNodeExpiry=lockTimeout] - Amount of time to wait if the redis
	...
	readLock(key, options = {}) {
		...
		let downNodeExpiry = (options.downNodeExpiry === undefined) ? lockTimeout : options.downNodeExpiry;
